    ...
    return (
        <section id="product-section">
            <div className="container">
                <div className="row">
                    <ProductCard title={comics[0].title} thumb={comics[0].thumb} />
                    <ProductCard title={comics[1].title} thumb={comics[1].thumb} />
                    <ProductCard title={comics[2].title} thumb={comics[2].thumb} />
                    <ProductCard title={comics[3].title} thumb={comics[3].thumb} />
                    <ProductCard title={comics[4].title} thumb={comics[4].thumb} />
                    <ProductCard title={comics[5].title} thumb={comics[5].thumb} />
                    <ProductCard title={comics[6].title} thumb={comics[6].thumb} />
                    <ProductCard title={comics[7].title} thumb={comics[7].thumb} />
                    <ProductCard title={comics[8].title} thumb={comics[8].thumb} />
                    <ProductCard title={comics[9].title} thumb={comics[9].thumb} />
                    <ProductCard title={comics[10].title} thumb={comics[10].thumb} />
                    <ProductCard title={comics[11].title} thumb={comics[11].thumb} />
                </div>
            </div>
        </section>
    )
